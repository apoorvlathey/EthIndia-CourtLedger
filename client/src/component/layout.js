        ...
        return (
            <div className="layoutBG">
                ...
                <div style={{ display: "flex", color: "#fbfbfb", marginLeft: "42vw" }}>
                    ...
                    <h3 style={{ marginTop: '10px', fontSize: '26px', color: "white", paddingBottom: "20px", textAlign: "center" }}>CourtLedger</h3>
                </div>
                <div className="table_body_scrollable">
                    {/* HIDE FROM HERE IF NOT AUTHENTICATED */}
                    {this.state.user === 4 ? (
                        <h1 style={{ color: "white", textAlign: "center", padding: "50px" }}> <u>Not Authorized to view</u></h1>
                    ) : this.state.user === 2 ? (
                        <>
                            <Form
